      ...
      <AnimatePresence>
        {!isOpen && (
          ...
          >
            ...
            <span className="text-sm font-semibold hidden sm:inline truncate">Ask Event Planner AI</span>
          </motion.button>
        )}
      </AnimatePresence>
            ...
            <div className="flex items-center justify-between px-4 py-3.5 bg-primary text-primary-foreground shrink-0">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-semibold leading-tight truncate">Event Planner AI</p>
                  <p className="text-[11px] opacity-80 truncate">AS Events Consultant</p>
                </div>
              </div>
              <button
                onClick={closeChat}
