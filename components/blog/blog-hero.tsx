  ...
  return (
    <section className="relative pt-32 pb-20 bg-slate-50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          <span className="text-primary font-medium tracking-widest uppercase text-sm">Blog</span>
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-foreground mt-4 mb-6 text-balance">
            Insights & <span className="text-gold-gradient">Inspiration</span>
          </h1>
          <p className="text-muted-foreground text-lg md:text-xl leading-relaxed">
            Expert tips, trends, and inspiration for creating unforgettable celebrations.
          </p>
        </motion.div>
      </div>
    </section>
